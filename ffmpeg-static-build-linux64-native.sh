...
# FFmpeg version
ffmpeg_package="https://ffmpeg.org/releases/ffmpeg-5.1.2.tar.bz2"
ffmpeg_package_name="ffmpeg-5.1.2.tar.bz2@ffmpeg-5.1.2"
...
cd ${dir_build}
tar jcvf ${name_folder}-linux-gnu-64bit-build-native.tar.bz2 *
rm -rf ${dir_build_packages}/${name_folder}-linux-gnu-64bit-build-native.tar.bz2
mv ${name_folder}-linux-gnu-64bit-build-native.tar.bz2 ${dir_build_packages}
echo ""
echo "* Your build: ${dir_build_packages}/${name_folder}-linux-gnu-64bit-build-native.tar.bz2"
echo ""
